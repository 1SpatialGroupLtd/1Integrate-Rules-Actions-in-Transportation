# [Essential Geometry Checks](Essential Geometry Checks.rules)
This repo folder contains the Essential Geometry Checks Ruleset that can be used within 1Integrate for ArcGIS.  
...
A copy of the license is available in the repository's [license.txt](LICNESE) file.